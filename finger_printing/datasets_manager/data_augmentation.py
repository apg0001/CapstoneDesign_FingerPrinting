...
# ✅ 증강할 세션 무작위 선택 (중복 허용)
sampled_keys = np.random.choice(all_keys, size=num_augmented_groups, replace=True)
...
output_path = os.path.join(OUTPUT_DIR, f"wifi_rssi_log_augmented_{timestamp}.csv")
